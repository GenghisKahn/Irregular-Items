...
import com.genghiskahn1992.irregularitems.tileentities.BasicQuantumGeneratorTile;
...
public class BasicQuantumGeneratorBlock extends ModBlock {

    public BasicQuantumGeneratorBlock() {
        super("basicquantumgenerator");
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new BasicQuantumGeneratorTile();
    }
